      ...
      <View style={styles.container} >
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={styles.welcomeContainer}>
            <Text  style={styles.welcomeText}>Welcome to Food Delivery App </Text>
            <Text  style={styles.welcomeText}>Let's start with Register!</Text>
        ...
        <View style={styles.bottomContainer} >
          ...
          <Text  onPress={this.navigateToLogin}  style={styles.createAccountText}>
